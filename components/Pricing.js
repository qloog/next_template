  ...
  return (
    <section className="bg-white text-black overflow-hidden" id="pricing">
      <div className="py-24 px-8 max-w-5xl mx-auto">
        ...
        <div className="text-black relative flex justify-center flex-col lg:flex-row items-center lg:items-stretch gap-8"
        style={{
          ...
          {config.stripe.plans.map((plan) => (
            <div key={plan.priceId} className="relative w-full max-w-lg">
              ...
              <div className="relative flex flex-col h-full gap-5 lg:gap-8 z-10 p-8 rounded-lg">
