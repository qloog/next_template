...
export default function Gallery() {
  ...
  useEffect(() => {
    const fetchImages = async (retryCount = 0) => {
      ...
      setError(null);
      try {
        const response = await fetch('/api/displayInGalleryPublic');
        if (!response.ok) {
...
/* this gallery works for the new logic hwere users can see 
their personalized dashboard uploaded public designs and can delete
this isnmt the OG gallery which ofc was the one that this 
feature doesnt work for 
