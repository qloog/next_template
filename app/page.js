      ...
      <main className="bg-white text-black">
        ...
        >
          <span className="font-extrabold text-lg">
            <h1 className="bg-clip-text text-transparent bg-gradient-to-br from-[#007880] to-[#9C009F] leading-tight  text-2xl lg:text-6xl tracking-tight md:-mb-4 text-align:left">
              {config.appName}
            </h1>
          </span>
